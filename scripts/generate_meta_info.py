...
#  python scripts/generate_meta_info.py --input datasets/train/DIV2K/DIV2K_train_HR --root datasets/train/DIV2K --meta_info datasets/train/DIV2K/meta_info/meta_info_DIV2Kmultiscale.txt
